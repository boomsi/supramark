...
Pod::Spec.new do |s|
  ...
  # iOS keeps the static XCFramework; macOS uses a dylib so its Rust runtime
  # does not collide with the host or other Rust static libraries.
  s.preserve_paths = ["ios/Frameworks/**", "macos/Frameworks/**"]
  s.ios.vendored_frameworks = "ios/Frameworks/SupramarkMarkdown.xcframework"
  s.osx.vendored_libraries = "macos/Frameworks/lib/libsupramark_markdown_native.dylib"
  s.ios.xcconfig = {
    "HEADER_SEARCH_PATHS" =>
