...
Pod::Spec.new do |s|
  ...
  # the supramark-mermaid-native staticlib for. Lowering this without a rebuild
  # would cause an SDK/ABI mismatch at link time.
  s.ios.deployment_target = "15.1"
  s.osx.deployment_target = "11.0"

  s.source_files = "ios/*.{h,m,mm}"
  s.public_header_files = "ios/SupramarkMermaidModule.h"
  ...
  s.ios.vendored_frameworks = "ios/Frameworks/SupramarkMermaid.xcframework"
  s.osx.vendored_libraries = "macos/Frameworks/lib/libsupramark_mermaid_native.dylib"
  s.ios.xcconfig = {
    "HEADER_SEARCH_PATHS" =>
      "\"$(PODS_TARGET_SRCROOT)/ios/Frameworks/SupramarkMermaid.xcframework/ios-arm64/Headers\" " \
      "\"$(PODS_TARGET_SRCROOT)/ios/Frameworks/SupramarkMermaid.xcframework/ios-arm64_x86_64-simulator/Headers\"",
